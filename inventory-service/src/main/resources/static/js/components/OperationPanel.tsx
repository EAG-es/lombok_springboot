...
const OperationPanel: React.FC = () => {
    const [formData, setFormData] = (window as any).React.useState({ id: '', productId: '', quantity: '' } as FormData);
    ...
    const [savedSearch, setSavedSearch] = (window as any).React.useState({ id: '', productId: '', quantity: '' } as FormData);
    const [savedPage, setSavedPage] = (window as any).React.useState(0);
    const [readSearch, setReadSearch] = (window as any).React.useState({ id: '', productId: '', quantity: '' } as FormData);
    ...
    const handleCreateSuccess = (createdInventory: any) => {
        setFormData({ id: createdInventory.id, productId: createdInventory.productId, quantity: createdInventory.quantity });
    ...
    const handleReadSuccess = (selectedInventory: FormData, searchCriteria: FormData, page: number) => {
    ...
    if (currentOp === 'read') {
        return (
            <ReadOp
                location={window.location.href}
                inventoryDTO={readSearch}
                setInventoryDTO={setFormData}
