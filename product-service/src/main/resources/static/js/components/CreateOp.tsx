...
const CreateOp: React.FC<CreateOpProps> = ({ location, productDTO, onSuccess, onError, lang }) => {
    ...
    (window as any).React.useEffect(() => {
        // Check if id is provided (should be blank for auto-generation)
        if (productDTO.id && productDTO.id.trim()) {
            onError(t.labelIdAutoGenerated);
            return;
        }
        ...
        const callEndpoint = async () => {
            try {
        // Make actual POST request to createProduct
        ...
        return (
            <div className="card shadow-lg border-0 mb-5">
                <div className="card-header bg-dark text-white px-4 py-3">
                    <h4 className="mb-0 text-center">Create Operation</h4>
                </div>
