...
class IndexPagePlaywrightTest {
    ...
    void testIndexPageLoads() {
        ...
        assertTrue(page.textContent("h1").contains("Order Service"), "Header should be in English");
        assertTrue(page.isVisible("text=Welcome to Order Processing"), "Welcome message should be in English");
    }
    ...
    void testLanguageSwitching() {
        ...
        page.waitForSelector("h1:has-text('Servicio de Pedidos')");

        // Assert Spanish content
        assertTrue(page.textContent("h1").contains("Servicio de Pedidos"), "Header should be in Spanish");
        assertTrue(page.isVisible("text=Bienvenido al Procesamiento de Pedidos"),
                "Welcome message should be in Spanish");

        // Switch back to English
        page.selectOption("select[name='lang']", "en");
        page.waitForSelector("h1:has-text('Order Service')");
